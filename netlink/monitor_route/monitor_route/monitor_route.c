// https://gist.githubusercontent.com/cl4u2/5204374/raw/98171a9b2ad9929555436d2fc1765c0848730774/route_monitor.c
	                ...
	                nlh = NLMSG_NEXT(nlh, received_bytes))
	{
		...
		*/
		...
		if (nlh->nlmsg_type == RTM_DELROUTE)
			fprintf(stdout,
				"Deleting route to destination --> %s/%d proto %d and gateway %s\n",
				\
			    destination_address,
				route_netmask,
				route_protocol,
